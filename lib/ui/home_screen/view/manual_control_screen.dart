...
import 'package:electro_farm/ui/flow/screens/pi_camera_screen.dart';
...
class _ManualControlScreenState extends State<ManualControlScreen> {
  ...
  @override
  void dispose() {
    _sendStop(); // ✅ no context used
    _sendTimer?.cancel();
    super.dispose();
  }

  void _emitCmd() {
    final vx = _maxVx * _joyY;
    final wz = _maxWz * _joyX;
    ...
    _socket.sendCmdVel(robotId: widget.robotId, vx: vx, wz: wz);
  }

  void _sendStop() {
    _socket.sendCmdVel(robotId: widget.robotId, vx: 0, wz: 0);
            ...
            children: [
              ...
              Container(
                ...
                child: _ControlsCard(
                  ...
                  onNudgeForward: () {
                    // quick tap forward
                    context.read<TelemetryProvider>().socketService.sendCmdVel(
                      robotId: widget.robotId,
                      vx: 0.15,
                      wz: 0.0,
                    );
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                "max ${maxVx.toStringAsFixed(1)} / ${maxWz.toStringAsFixed(1)}",
                style: TextStyle(
                  fontSize: 11,
